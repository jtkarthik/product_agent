...
def main(host: str, port: int):
    skill = AgentSkill(
        id="product-query-agent",
        name="product-query-agent",
        description="An AI agent that answers natural language queries about Products in an SAP S/4HANA system",
        tags=["product", "query", "s4hana", "agent"],
        examples=["What is the base unit of measure for product TG11?", "Show me the classification of product FG126"],
    )
